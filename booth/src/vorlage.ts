...
/**
 * Die eigenen Vorlagen. Sie sind der Ausgangspunkt jeder Änderung — im Editor
 * wird kopiert, nicht bei Null angefangen. Der übernommene Katalog kommt
 * zusätzlich aus `vorlagen-katalog.json`.
 */
export function eigeneStandards(): Vorlage[] {
  return [
    {
      id: 'foto-klassisch',
      name: 'Klassik Foto',
      ...
      akzent: '#6b6355',
      felder: [
        { id: 'f1', art: 'bild', x: 0.05, y: 0.0333, b: 0.9, h: 0.45 },
        textfeld('f2', 0.535, '{event}', 46, { gewicht: 800 }),
        textfeld('f3', 0.577, '{datum}', 22, {
          gewicht: 500,
          schrift: 'mono',
          versalien: true,
    ...
    },
    {
      ...
      felder: [
        ...
        textfeld('g3', 0.875, '{event}', 52, {
          gewicht: 800,
          versalien: true,
          farbe: '#f6f4f1',
        }),
        textfeld('g4', 0.935, '{datum} · {zeit}', 22, {
          gewicht: 500,
          schrift: 'mono',
          versalien: true,
          farbe: '#f2b23e',
    ...
    },
    {
      ...
      felder: [
        ...
        textfeld('s4', 0.861, '{event}', 33, { gewicht: 800 }),
        textfeld('s5', 0.907, '{datum}', 16, {
          gewicht: 500,
          schrift: 'mono',
          versalien: true,
          farbe: 'rgba(0,0,0,0.45)',
    ...
    },
    {
      ...
      felder: [
        ...
        { id: 'd4', art: 'flaeche', x: 0.05, y: 0.8361, b: 0.9, h: 0.0044, farbe: '#f2b23e' },
        textfeld('d5', 0.883, '{event}', 32, {
          gewicht: 800,
          versalien: true,
          farbe: '#f6f4f1',
        }),
        textfeld('d6', 0.927, '{datum} · {box}', 15, {
          gewicht: 500,
          schrift: 'mono',
          versalien: true,
