...
import { Pruefer, SchemaFehler } from './pruefer.js';

export { Pruefer, SchemaFehler, type Verstoss } from './pruefer.js';
...
export function pruefeEntwurf(roh: unknown): Entwurf {
  ...
  const entwurf: Entwurf = {
    ...
    // Vor Fassung 2 gab es das Feld nicht: fehlend heißt „keine Aussage",
    // nicht „ungültig". Sonst wäre jeder Altentwurf unladbar.
    aussageId:
      o['aussageId'] === null || o['aussageId'] === undefined
        ? null
        : p.text(o['aussageId'], '$.aussageId', { nichtLeer: true }),
