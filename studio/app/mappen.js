/* Mappen — mehrere Dateien gleichzeitig offen, als Reiter in der Titelleiste.
   ...
   Der Zustand des Studios war auf genau ein Arbeitsdokument gebaut: eine
...
export function schliesse(id) {
  ...
  if (mappen.length === 1) {
    /* Die letzte Mappe wird geleert statt entfernt: ein Studio ohne
