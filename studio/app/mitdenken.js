/* Mitdenken — der Teil, der das Studio von einem Betrachter unterscheidet.
...
function alleVorschlaege() {
  ...
  if (befunde.muster.length) {
    ...
    liste.push({
      ...
      text: `Gefunden: ${arten.join(', ')}. Vor der Weitergabe schwärzen? Das Studio rastert die betroffenen Seiten, damit der Text wirklich verschwindet.`,
  ...
  if (zustand.geaendert) {
    liste.push({
      ...
      text: 'Das Studio speichert nichts von selbst — nichts verlässt dieses Gerät, auch nicht in einen Zwischenspeicher.',
      knopf: 'Sichern',
      befehl: 'sichern',
      gewicht: 70,
    });
