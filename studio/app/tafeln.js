...
export function zeichneRechteTafel() {
  ...
  if (zeichnend) {
    ...
    if (zustand.werkzeug === 'ersetzen') {
      abschnitt.append(el('p', { klasse: 'hinweis', text: 'Auf ein Textstück klicken. Das Studio übernimmt Lage, Größe und Farben und setzt den neuen Text an dieselbe Stelle.' }));
    }
