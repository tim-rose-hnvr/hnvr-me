...
export function zeigeUnterschriftDialog(beiFertig) {
  ...
  bildwahl.addEventListener('change', () => {
    ...
    leser.onload = () => {
      ...
      // hatte das Studio ein Verhältnis geraten — die Unterschrift wurde
  ...
  const rumpf = el('div', {}, reiter, zeichenBereich, tippBereich, bildBereich,
    el('p', { klasse: 'hinweis', stil: { marginTop: '1rem' } },
      'Sichtbare Unterschrift, keine kryptografische Signatur. Für rechtsverbindliches Signieren nach eIDAS braucht es ein Zertifikat und eine Signaturkarte — das kann dieses Studio nicht.'));
