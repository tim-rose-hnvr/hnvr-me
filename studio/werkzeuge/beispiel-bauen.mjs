...
/* Optionsfeld — damit das Studio auch diese Feldart zu sehen bekommt. */
...
/* Ein echtes Unterschriftsfeld (/FT /Sig). pdf-lib hat dafür keine bequeme
   ...
   eingehängt — so kann das Studio den Klick darauf beantworten. */
...
/* Lesezeichen — von Hand, weil pdf-lib dafür keine Schnittstelle hat.
   Damit ist die Gliederungstafel des Studios am Beispiel prüfbar. */
...
dok.setSubject('Beispieldatei des Studios');
dok.setProducer('PDF Studio — Beispielbauer');
