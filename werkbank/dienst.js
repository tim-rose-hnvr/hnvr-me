/* Dienst — der Service Worker der Werkbank.

   Er macht aus der Seite eine Anwendung, die man installiert: eigenes Fenster,
   Symbol im Dock oder Startmenü, und vor allem — sie läuft ohne Netz.

   Das ist keine Bequemlichkeit, sondern Leitprinzip 2. Eine Werkbank, die im
   ...
   **Kern** — was jeder Start braucht: das Gerüst, alle Module, die Schriften,
   ...
   Werkbank installiert, hat sie danach vollständig.
...
const KERN = [
  ...
  'manifest.json',
  'app/stil.css',
  'app/anmeldung.js', 'app/anmerkungen.js', 'app/ansicht.js', 'app/ausgabe.js',
  'app/barrierefrei.js', 'app/dialoge.js', 'app/dokument.js', 'app/einlesen.js',
  'app/excel.js', 'app/formulare.js', 'app/installieren.js', 'app/kern.js',
    ...
    ereignis.respondWith((async () => {
      try {
        ...
        return (await caches.match('index.html')) || (await caches.match('./'))
          || new Response('Die Werkbank ist noch nicht für offline eingerichtet.',
